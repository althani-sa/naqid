    ...
    >
      ...
      <div className="grid grid-cols-5 desc:grid-cols-3 tab:grid-cols-2 gap-32 mt-36 tab:px-10 w-full">
        {trainersTeam.map(({ name, image }, i) => {
          return (
            <div
              className="relative after:centerH after:bottom-0 after:w-full min-h-[25rem] w-full after:aspect-square after:bg-darkBlue after:rounded-full after:-z-20 before:centerH before:top-full before:w-[130%] before:h-4 before:bg-darkBlue before:rounded-full mb-20 z-10"
              key={i}
            >
              <Image
                src={image}
                ...
                width={10000}
                height={1000}
                className="mx-auto h-[20rem] w-auto centerH bottom-0"
              />
