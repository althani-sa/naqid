  ...
  let homepageData: HomepageProps = {
    ...
    programDetails: [
      ...
      },
      {
        ...
        brief:
          "تركز ورش العمل في هذا المحور على تحليل مسودات المشروعات النقدية المقدمة من قبل المتدربين، وتقديم ملاحظات متخصصة وخطة لتطوير تلك المشروعات إلى أعمال نقدية قابلة للنشر. ",
      },
      {
        icon: icon8.src,
        whiteIcon: icon8.src,
    ...
    faqs: [
      {
        ...
        answer:
          "يعد البرنامج الأول من نوعه في المملكة العربية السعودية لدعم حركة النقد والتحليل الإبداعي وتنمية مهارات التعامل مع الأعمال الإبداعية، ويوفر فرصة اللقاء والحوار بين المبدعين والنقاد، وهو أول برنامج نقدي مدعوم قبل وزارة الثقافة ممثلة بهيئة الأدب والنشر والترجمة. ",
      },
      {
      ...
      },
      {
        ...
        answer: `
        <a href="tel:+966 11 467 9968">
         رقم الهاتف: +966 11 467 9968
         </a>
         <br />
